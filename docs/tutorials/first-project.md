# Tutorial: Your First Stax Project

Welcome to Stax! This tutorial guides you through setting up your first WordPress development environment.

## What You'll Learn

In this tutorial, you will:
- Install Stax and its prerequisites
- Initialize a WordPress project
- Pull a database from WPEngine
- Access your local development site
